...
{
    // return the integration points of the linear surface quad element
    std::vector<Vector3d> IP;
...
std::vector<Vector3d> LineQuadriIPSurfaceTri()
{
    // return the integration points of the linear surface tri element
    std::vector<Vector3d> IP;
    // Coordinates and weight
    IP.push_back(Vector3d(1./3,1./3,1.));
    return IP;
}
//-----------------------------//
// Basis functions
...
std::vector<double> evalShapeFunctionsSurfaceTriR(double xi,double eta)
{
    std::vector<double>  R = {1.-xi-eta,xi,eta};
    return R;
}
std::vector<double> evalShapeFunctionsSurfaceTriRxi(double xi,double eta)
{
    std::vector<double> Rxi={-1.,1.,0.};
    return Rxi;
}
std::vector<double> evalShapeFunctionsSurfaceTriReta(double xi,double eta)
{
